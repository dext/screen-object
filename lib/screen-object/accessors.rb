module ScreenObject
  ...
  module Accessors
    ...
    def button(name, locator)
      ...
      # button(:login_button, xpath: '//UIButtonField') # button API should have class name as shown in this example.
      # OR
      # button(:login_button, xpath: '//UIButtonField/UIButtonFieldtext') # button API should have class name as shown in this example.
      # def scroll_button
